<?php
  ...
  *  option) any later version.                                              *
  ...
  /* Commented entries are no longer available, as of Oct 22, 2003 - shrykedude */
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (127,'T','babyblue','Jerry Scott & Rick Kirkman','Baby Blues','',0,0,'http://www.babyblues.com/','http://est.rbma.com/content/Baby_Blues?date={y}{m}{d}','','','','Su:Mo:Tu:We:Th:Fr:Sa','None','General',0,'Static',14,585,585)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (12,'T','buckets','Scott Stantis','Buckets','',0,0,'http://www.unitedmedia.com/comics/buckets/','','','','','Su:Mo:Tu:We:Th:Fr:Sa','United','General',0,'Remote',0,600,725)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (29,'T','curtis','Ray Billingsley','Curtis','curt',0,104,'http://www.kingfeatures.com/features/comics/curtis/aboutMaina.php','http://est.rbma.com/content/Curtis?date={y}{m}{d}','','','','Su:Mo:Tu:We:Th:Fr:Sa','None','General',0,'Remote',14,585,585)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (32,'T','familycircus','Bil Keane','The Family Circus','fam',0,109,'http://www.kingfeatures.com/features/comics/familyc/about.htm','http://est.rbma.com/content/Family_Circus?date={y}{m}{d}','','','','Su:Mo:Tu:We:Th:Fr:Sa','None','General',0,'Remote',14,263,263)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (34,'T','Funky','Tom Batiuk','Funky Winkerbean','funk',0,124,'http://www.kingfeatures.com/features/comics/fwinker/about.htm','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Toonville','General',0,'Remote',0,585,585)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (68,'T','Zits','Jerry Scott & Jim Borgman','Zits','zits',0,145,'','http://est.rbma.com/content/Zits?date={y}{m}{d}','','','','Su:Mo:Tu:We:Th:Fr:Sa','King','General',0,'Remote',0,585,585)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (69,'T','fredbasset','Alex Graham','Fred Basset','tmfba',0,0,'','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Ucomics','General',0,'Remote',7,600,600)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (70,'T','boundandgagged','Dana Summers','Bound & Gagged','tmbou',0,0,'','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Ucomics','General',0,'Remote',0,600,600)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (72,'T','middletons','Ralph Dunagin & Dana Summers','The Middletons','tmmid',0,0,'','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Ucomics','General',0,'Remote',0,600,600)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (73,'T','pluggers','Brookins (Submissions)','Pluggers','tmplu',0,0,'http://www.ucomics.com/pluggers/','','','','','Su:Mo:Tu:We:Th:Fr:Sa','ComicsPage','General',0,'Remote',0,300,580)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (74,'T','alleyoop','Dave Gaue & Jack Bender','Alley Oop','',0,0,'http://www.comics.com/comics/alleyoop/','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Comiczone7','General',0,'Remote',0,600,725)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (92,'T','robotman','Jim Meddick','Robotman','monty',0,0,'http://www.unitedmedia.com/comics/robotman/','','','','','Su:Mo:Tu:We:Th:Fr:Sa','United','General',0,'Remote',0,600,725)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (103,'T','crankshaft','Tom Batiuk & Chuck Ayers','Crankshaft','cs',0,0,'http://www.ucomics.com/crankshaft/','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Ucomics','General',0,'Remote',14,600,600)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (111,'T','hth','George Gately','Heathcliff','hth',0,101,'','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Creators','General',0,'Remote',0,300,300)");
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (122,'T','frankernest','Bob Thaves','Frank and Ernest','frank',0,126,'http://www.unitedmedia.com/comics/franknernest/','','','','','Su:Mo:Tu:We:Th:Fr:Sa','United','General',0,'Remote',0,585,585)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (124,'T','KevKel','Bill Holbrook','Kevin & Kell','kk',0,149,'http://www.kevinandkell.com/','http://www.kevinandkell.com/{y}/strips/kk{y}{m}{d}.gif','','','','Su:Mo:Tu:We:Th:Fr:Sa','None','General',0,'Remote',0,585,585)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (123,'T','Hilois','Browne, Walker, and Walker','Hi and Lois','Hi',0,105,'http://www.kingfeatures.com/features/comics/hi_lois/about.htm','http://est.rbma.com/content/Hi_and_Lois?date={y}{m}{d}','','','','Su:Mo:Tu:We:Th:Fr:Sa','None','General',0,'Remote',0,585,585)");
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (125,'T','Grimmy','Mike Peters','Mother Goose & Grimm','tmmgg',0,148,'http://www.kingfeatures.com/features/comics/grimmy/about.htm','http://est.rbma.com/content/Mgoose?date={y}{m}{d}','','','','Su:Mo:Tu:We:Th:Fr:Sa','King','General',0,'Remote',0,600,600)");
?>
