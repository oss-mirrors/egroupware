<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
	...
	$oProc->query("INSERT INTO phpgw_comic_data VALUES (99,'T','citizendog','Mark O\'Hare','Citizen Dog','cd',0,0,'','','','','','Su:Mo:Tu:We:Th:Fr:Sa','Ucomics','General',0,'Remote',0,600,600)");
