<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
	...
	$GLOBALS['phpgw']->db->query("select * from phpgw_polls_data where vote_id=$vote_id AND poll_id=$poll_id");
	...
	$GLOBALS['phpgw']->template->set_var('form_button_2','</form><form method="POST" action="' . $GLOBALS['phpgw']->link('/polls/admin.php','show=answers')
