...
insert into phpgw_applications (app_name,app_title,app_enabled,app_order,app_tables,app_version) values ('polls','Vooting Booth','1','','phpgw_polls_user:user_id','0.8.1pre1');
