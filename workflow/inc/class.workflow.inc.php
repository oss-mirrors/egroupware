	...
	class workflow
	{
		...
		function fill_proc_bar($proc_info)
		{
			...
			$this->t->set_var(array(
				...
				'link_admin_processes'	=> $GLOBALS['phpgw']->link('/index.php', 'menuaction=workflow.ui_processmanager.admin_processes&pid='. $proc_info['pId']),
				...
				'link_save_process'		=> $GLOBALS['phpgw']->link('/index.php', 'menuaction=workflow.ui_processmanager.save_process&id='. $proc_info['pId']),
