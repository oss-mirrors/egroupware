...
<tr>
	...
	<a style="font-size: x-small;" href="compact.php?<?php echo _rsidl; ?>">Compact Messages</a><br>
	<a style="font-size: x-small;" href="admsync.php?<?php echo _rsidl; ?>">Syncronize FUDforum Sources</a><br><br>
