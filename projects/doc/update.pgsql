...
# update : 11/30/2000 #
#######################
replace into applications(app_name,app_title,app_enabled,app_tables,app_version) values('projects','Projects',1,'p_activities,p_projectactivities,p_delivery,p_deliverypos,p_hours,p_invoice,p_invoicepos,p_projectmembers,p_projects','0.8.2');
drop table p_projectaddress;
alter table p_projects add column address int;                                               