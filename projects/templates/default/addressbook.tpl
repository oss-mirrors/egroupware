...
<script LANGUAGE="JavaScript">
	...
	{
		opener.document.app_form.abid.value = thisform.elements['contactid'].value;
		opener.document.app_form.name.value = thisform.elements['contactname'].value;
	}
</script>
</head>
...
<!-- BEGIN abook_list -->
	...
	<tr bgcolor="{tr_color}">
		...
		<form>
		<input type="hidden" size="25" name="contactid" value="{abid}">
		<input type="hidden" size="25" name="contactname" value="{company} {firstname} {lastname}">
