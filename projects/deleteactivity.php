<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
    ...
    if (! $id)
    {
	Header('Location: ' . $phpgw->link('/projects/activities.php',"sort=$sort&order=$order&query=$query&start=$start&filter=$filter"));
    }
	...
	$t->set_var('deleteheader',lang('Are you sure you want to delete this activity'));
