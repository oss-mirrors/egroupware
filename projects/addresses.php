...
/* $Id$ */
  ...
  $t->set_file(array("address_list_t" => "addresses.tpl",
                     "address_list"   => "addresses.tpl"));
  $t->set_block("address_list_t","address_list","list");
  
  $t->set_var(title,$phpgw_info["site_title"]);
  $t->set_var(bg_color,$phpgw_info["theme"]["bg_color"]);
  $t->set_var(lang_address_action,lang("Address book"));
...
// =================================================
  ...
  $next_matchs = $phpgw->nextmatchs->show_tpl("addresses.php",$start,$phpgw->db->f(0),
...
// ==================================================
  ...
  $t->parse("list","address_list", true);
...
// ==================================================
 ...
 $t->parse("out","address_list_t", true);
 $t->p("out");
