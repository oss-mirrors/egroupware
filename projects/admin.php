<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
    ...
    if ($query) { $querymethod = " AND account_lid like '%$query%' OR account_lastname like '%$query%' OR account_firstname like '%$query%'"; }
...
//--------------------------------- nextmatch --------------------------------------------
    ...
    if ($total_records > $limit) { $t->set_var('lang_showing',lang("showing x - x of x",($start + 1),($start + $limit),$total_records)); }
    else { $t->set_var('lang_showing',lang("showing x",$total_records)); }
