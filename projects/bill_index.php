...
//---------------------- nextmatch variable template-declarations ---------------------------
	...
	$left = $phpgw->nextmatchs->left('/projects/bill_index.php',$start,$projects->total_records);
	$right = $phpgw->nextmatchs->right('/projects_bill_index.php',$start,$projects->total_records);
	$t->set_var('left',$left);
