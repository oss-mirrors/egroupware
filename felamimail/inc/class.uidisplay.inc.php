	...
	*/
	...
	class uidisplay
	{
		...
		function makeComposeLink($email,$text)
		{
			...
			return "<a href=\"$link\" target=\"compose\" onclick=\"h=window.open(this,this.target,'dependent=yes,width=870,height=650,location=no,menubar=no,toolbar=no,scrollbars=yes,status=yes'); he=screen.availHeight; h.resizeTo(870,he); return false;\"><font color=\"blue\">".$text."</font></a>";
		}
