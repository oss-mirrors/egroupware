   ...
   function parseEmail (&$body) {
      ...
      if ($what && ($where == "BODY" || $where == "TEXT")) {
         ...
         if ($oldaddr) {
            ...
            $body = str_replace ($oldaddr, "<a href=\"compose.php?send_to=$oldaddr\">$newaddr</a>", $body); 
         }
      } else { 
         $body = eregi_replace ($Expression, "<a href=\"compose.php?send_to=\\0\">\\0</a>", $body);
      }
      */
      ...
      $body = eregi_replace ($Expression, "<a href=\"" . $GLOBALS['phpgw']->link('/index.php',$linkData) . "\">\\0</a>", $body); 
