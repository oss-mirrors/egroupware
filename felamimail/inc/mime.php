...
/** Added to grab phpGW_type **/
   ...
   function formatBody($imap_stream, $message, $color, $wrap_at) {
      ...
      if (($body_message->header->type0 == "text") || 
         ...
         $body .= '<SMALL><CENTER><A class="body_link" HREF="'.$phpgw->link('/felamimail/download.php',"absolute_dl=true&passed_id=$id&passed_ent_id=$ent_num&mailbox=$urlmailbox").'">'. lang("Download this as a file") ."</A></CENTER><BR></SMALL>";
