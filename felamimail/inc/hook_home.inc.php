	...
	if ($GLOBALS['phpgw_info']['user']['preferences']['felamimail']['mainscreen_showmail'] == True)
	{
		...
		else
		{
			...
			*/
			...
			$portalbox = CreateObject('phpgwapi.linkbox',Array($title,$GLOBALS['phpgw_info']['theme']['navbar_bg'],$GLOBALS['phpgw_info']['theme']['bg_color'],$GLOBALS['phpgw_info']['theme']['bg_color']));
			$portalbox->setvar('width',600);
			$portalbox->outerborderwidth = 0;
			$portalbox->header_background_image = $GLOBALS['phpgw_info']['server']['webserver_url'] . '/phpgwapi/templates/verdilak/images/bg_filler.gif';
