 ...
 **/
   ...
   $i18n_php = true;
   if (! isset($felamimail_language)) { $felamimail_language = ''; }
   ...
   function set_up_language($sm_language, $do_search = false)
   {
      static $SetupAlready = 0;
		global $HTTP_ACCEPT_LANGUAGE, $use_gettext, $languages, $felamimail_language;
      ...
      if (isset($sm_language) && $use_gettext &&
         ...
         bindtextdomain('felamimail', '../locale/');
         textdomain('felamimail');
