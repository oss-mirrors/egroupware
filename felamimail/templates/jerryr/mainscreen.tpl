...
<TABLE class="calDayView" WIDTH="100%" >
...
-->
	<TR>
		...
		<TD width="30%" align="center" style="white-space: nowrap;">
			<b>{current_folder}</b>
		</td>
		<td width="30%" align="center" style="white-space: nowrap;">
			{quota_display}
...
<TABLE  width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<TR>
		<td valign="top" class="folderlist" width="180">
			...
			<div id="divFolderTree" style="overflow:auto; width:200px; height:374px; margin-bottom: 0px;padding-left: 0px; padding-top:0px; z-index:100; border : 0px solid Silver;">
				<table class="calDayViewShadowBox" width=100% BORDER="0" style="table-layout:fixed;padding-left:2;">
					<tr height="320">
...
<!-- ToDo: ResizeVerticalRule -->		
		...
		<TD valign="top">
			...
			<div id="divMessageList" style="overflow:auto; height:360px; margin-left:0px; margin-right:0px; margin-top:0px; margin-bottom: 0px; z-index:90; border : 0px solid Silver;">
				<table class="calDayViewShadowBox" BORDER="0" style="width:100%; padding-left:2; table-layout: fixed;">
					{header_rows}
				</table>
			</div>
