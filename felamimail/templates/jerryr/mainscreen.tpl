...
<!-- BEGIN message_table -->
<div id="divMessageTableList" style="height:{messagelist_height}; margin-left:0px; margin-right:0px; margin-top:0px; margin-bottom: 0px; z-index:90; border : 1px solid #9f9f9f; border-top: 0px; background-color: white;">
...
<script type="text/javascript">
	...
	function handleResize()
	{
		...
		if (typeof divMessageTableList != 'undefined' && divMessageTableList != null)
		{
			...
			{
				var height = $(document).height() - iframeheight - $(divMessageTableList).offset().top - 85;
			}
			else
			{
				var height = $(document).height() - iframeheight - $(divMessageTableList).offset().top - 112;
			}
