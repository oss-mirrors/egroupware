...
<TABLE  width="100%" cellpadding="0" cellspacing="0" border="0" style="height:100px;">
	...
	<TR>
		...
		<TD valign="top" colspan="3">
			...
			<div id="divMessageList" style="overflow:auto; height:460px; margin-left:0px; margin-right:0px; margin-top:0px; margin-bottom: 0px; z-index:90; border : 1px solid #9f9f9f; border-top: 0px; background-color: white;">
...
<!-- BEGIN header_row_felamimail -->
	<tr id="row_{message_uid}" class="{row_css_class}" onMouseOver="style.backgroundColor='#dddddd';" onMouseOut="javascript:style.backgroundColor='#FFFFFF';">
		...
		<td class="mainscreenRow" align="right" style="overflow:hidden; white-space:nowrap;" width="120px"><nobr>
...
<!-- BEGIN table_header_felamimail -->
			<table WIDTH=100% BORDER="0" CELLSPACING="0" cellpadding="0" height="22" style="table-layout:fixed; border: 1px solid #9f9f9f; border-bottom:1px solid #9f9f9f;"; >
				<tr class="th" id="tableHeader">
					<td width="20px" align="left" style="border-right: 1px solid #9f9f9f; border-left:1px solid white;">
					...
					<td width="20px" bgcolor="{th_bg}" align="center" class="text_small" style="border-right: 1px solid #9f9f9f; border-left:1px solid white;">
						&nbsp;
					</td>
					<td width="20px" bgcolor="{th_bg}" align="center" class="text_small" style="border-right: 1px solid #9f9f9f; border-left:1px solid white;">
						&nbsp;
					</td>
					<td class="fmToggle" onMouseOver="this.className='fmToggleOver'" onMouseOut="this.className='fmToggle';" onclick="this.className='fmTogglePush'; changeSorting('subject', this); return false;">
					<a href="#">{lang_subject}</a>
					</td>
					<td width="95px" class="fmToggle" onMouseOver="this.className='fmToggleOver'" onMouseOut="this.className='fmToggle';" onclick="this.className='fmTogglePush'; changeSorting('date', this); return false;">
						&nbsp;&nbsp;<a href="#">{lang_date}</a>
					</td>
					<td width="120px" class="fmToggle" onMouseOver="this.className='fmToggleOver'" onMouseOut="this.className='fmToggle';" onclick="this.className='fmTogglePush'; changeSorting('from', this); return false;">
						&nbsp;<a href="#"><span id='from_or_to'>{lang_from}</span></a>
					</td>
					<td width="40px" class="fmToggle" onMouseOver="this.className='fmToggleOver'" onMouseOut="this.className='fmToggle';" onclick="this.className='fmTogglePush'; changeSorting('size', this); return false;">
						<a href="#">{lang_size}</a>&nbsp;
					</td>
					<td width="15px" bgcolor="{th_bg}" align="center" class="{css_class_size}" style="border-left:1px solid white;">
						&nbsp;
					</td>
				</tr>
			</table>
