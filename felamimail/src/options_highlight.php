...
?>
   ...
   <table width=95% align=center border=0 cellpadding=2 cellspacing=0><tr><td bgcolor="<?php echo $color[0] ?>">
      <center><b><?php echo lang("Options") . " - " . lang("Message Highlighting"); ?></b></center>
   </td></tr></table>

<?php
   echo "<br><center>[<a href=\"options_highlight.php?action=add\">" . lang("New") . "</a>]";
   ...
   if (count($message_highlight_list) >= 1) {
      ...
      for ($i=0; $i < count($message_highlight_list); $i++) {
         ...
         echo "<nobr><small>[<a href=\"options_highlight.php?action=edit&theid=$i\">" . lang("Edit") . "</a>]&nbsp;[<a href=\"options_highlight.php?action=delete&theid=$i\">".lang("Delete")."</a>]</small></nobr>\n";
         echo "   </td>";
