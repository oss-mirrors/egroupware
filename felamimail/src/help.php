...
<?php
   ...
   if (!$felamimail_language)
      $felamimail_language = "en";

   if (file_exists("../help/$felamimail_language")) {
      $help_exists = true;
      $user_language = $felamimail_language;
   ...
   if ($help_exists) {
      ...
      if (!isset($chapter)) {
         ...
         if ($chapter <= 1) echo "<font color=\"$color[9]\">".lang("Previous")."</font> | ";
         else echo "<a href=\"../src/help.php?chapter=".($chapter-1)."\">".lang("Previous")."</a> | ";
         echo "<a href=\"../src/help.php\">".lang("Table of Contents")."</a>";
         if ($chapter >= count($helpdir)) echo " | <font color=\"$color[9]\">".lang("Next")."</font>";
         else echo " | <a href=\"../src/help.php?chapter=".($chapter+1)."\">".lang("Next")."</a>\n";
         ...
         echo "<br><center><a href=\"#pagetop\">" . lang("Top") . "</a></center>\n";
      }
   }
   do_hook("help_bottom"); 
?>
