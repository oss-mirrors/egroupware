...
Transformed by <a href="<?php echo $phpgw->link('/index.php','menuaction=felamimail.uicompose.compose&send_to=lkneschke@phpgroupware.org'); ?>">Lars Kneschke (knecke)</a><br/>
</font>
