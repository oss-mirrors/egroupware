...
class Group
{
	 ...
	 * Dies ist jedoch nicht mit einem L�schen des entsprechenden Eintrags aus phpgw_mydms_Groups geschehen - vielmehr
	 * muss daf�r gesorgt werden, dass die Gruppe nirgendwo mehr auftaucht. D.h. auch die Tabellen phpgw_mydms_ACLs,
	 * phpgw_mydms_Notify und phpgw_mydms_GroupMembers m�ssen ber�cksichtigt werden.
	 */
	function remove()
	{
		GLOBAl $db;
