<?php
    ...
    * option) any later version.                                               *
	...
	function about_app($tpl,$handle)
	{
		...
		$s .= $t->set_var('app_version',$GLOBALS['phpgw_info']['apps']['stocks']['version']);
		...
		$s .= $t->set_var('source_url','http://www.dansteinman.com/php/pstocks/');
		$s .= $t->set_var('source_url_name','www.dansteinman.com/php/pstocks/');
