  ...
  if (isset($sno) && $sno->kindOf()=="array") {
	...
	while (list( $key, $val ) = each( $agesorter_arr ) ) {
	  ...
	  $outAr[] = CreateObject('phpgwapi.xmlrpcval',array(
		...
		"age"  => CreateObject('phpgwapi.xmlrpcval',$val, "int")), "struct");
	}
...
function v1_simpleStructReturn($m) {
  $sno=$m->getParam(0);
	...
	return CreateObject('phpgwapi.xmlrpcresp',CreateObject('phpgwapi.xmlrpcval',array(
																						"times10" =>
																						CreateObject('phpgwapi.xmlrpcval',$v*10, "int"),
																						"times100" =>
																						CreateObject('phpgwapi.xmlrpcval',$v*100, "int"),
																						"times1000" =>
																						CreateObject('phpgwapi.xmlrpcval',$v*1000, "int")), 
																			"struct"));
}
...
function v1_countTheEntities($m) {
  $sno=$m->getParam(0);
	...
	return CreateObject('phpgwapi.xmlrpcresp',CreateObject('phpgwapi.xmlrpcval',array("ctLeftAngleBrackets" =>
														 CreateObject('phpgwapi.xmlrpcval',$lt, "int"),
														 "ctRightAngleBrackets" =>
														 CreateObject('phpgwapi.xmlrpcval',$gt, "int"),
														 "ctAmpersands" =>
														 CreateObject('phpgwapi.xmlrpcval',$amp, "int"),
														 "ctApostrophes" =>
														 CreateObject('phpgwapi.xmlrpcval',$ap, "int"),
														 "ctQuotes" =>
