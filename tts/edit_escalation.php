	...
	*  option) any later version.                                              *
	...
	if($_POST['save'])
	{
		...
		if (!$escalation_id)
		{
			...
			. intval($escalation['ticket_group']) . ", "
                        . intval($escalation['ticket_priority_1']) . ", "
                        . intval($escalation['ticket_priority_2']) . ", "
                        . intval($escalation['time_1']) . ", "
                        . intval($escalation['time_2']) . ", "
                        . intval($escalation['time_3']) . ", "
                        . ($escalation['email_2']=='on'?1:0). ", "
                        . ($escalation['email_2']=='on'?1:0). ")",__LINE__,__FILE__);
		...
		else
		{
			$GLOBALS['phpgw']->db->query("update phpgw_tts_escalation "
				. " set ticket_group=". intval($escalation['ticket_group']). ", "
				. " ticket_priority_1=". intval($escalation['ticket_priority_1']). ", "
                                . " ticket_priority_2=". intval($escalation['ticket_priority_2']). ", "
                                . " time_1=". intval($escalation['time_1']). ", "
                                . " time_2=". intval($escalation['time_2']). ", "
                                . " time_3=". intval($escalation['time_3']). ", "
                                . " email_1=". ($escalation['email_1']=='on'?1:0). ", "
                                . " email_2=". ($escalation['email_2']=='on'?1:0)
				. " WHERE escalation_id=".$escalation_id,__LINE__,__FILE__);
