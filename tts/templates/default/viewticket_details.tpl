...
<!-- BEGIN form -->
	...
	<form method="POST" action="{viewticketdetails_link}">
		...
		<table border="0" width="80%" cellspacing="0" align="center">
			...
			<tr bgcolor="{row_off}">
				<td align="left">{lang_state}:</td>
				<td colspan="3" align="left"><b>{value_state}</b></td>
			</tr>
			...
			<tr bgcolor="{row_off}">
				<td colspan="4"><b>{lang_update_state}:</b><hr></td>
			</tr>

			<tr bgcolor="{row_off}">
				<td colspan="4"><input name="ticket[state]" type="radio" value="0" CHECKED>{lang_keep_present_state}</td>
			</tr>
