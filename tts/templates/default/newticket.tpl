...
<table border="0" width="80%" cellspacing="0" align="center">
	...
	<tr class="row_off">
		<td>{lang_subject}:</td>
		<td colspan="3"><input name="ticket[subject]" value="{value_subject}" size="65"></td>
	</tr>

	<tr class="row_on">
		<td>{lang_details}:</td>
		<td colspan="3"><textarea rows="10" name="ticket[details]" cols="65" wrap="hard">{value_details}</textarea></td>
	</tr>
