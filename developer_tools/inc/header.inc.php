<?php
	...
	$t->set_var('lang_sourceforge_project','<a href="' . $phpgw->link('/index.php','menuaction=developer_tools.uisf_project_tracker.display_tracker') . '">' . lang('SF Project tracker') . '</a>');
