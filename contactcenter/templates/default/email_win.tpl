...
<div id="cc_email_win" style="position: absolute; width: 600px; height: 350px; visibility: hidden; z-index: 0; border: 1px solid #999; border-top: 0px; background-color: #eee;">
					...
					<tr>
						<td valign="top">
							<table border="0">
								...
								<tr>
									<td><div id="cc_email_catalogues" style="position: relative; width: 250px; height: 110px; border: 1px solid #999; overflow: auto" class="row_on"></div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td><select id="cc_email_win_entries" style="width: 250px; height: 110px; overflow: auto;" multiple></select></td>
								</tr>
							</table>
						</td>
						<td valign="top">
							<table border="0" width="100%" height="100%">
								...
								<tr>
									...
									<td><select id="cc_email_win_to" style="width: 200px; height: 65px;" multiple></select></td>
								</tr>
								<tr>
									<td></td>
									<td>{cc_label_cc}</td>
								...
								<tr>
									...
									<td><select id="cc_email_win_cc" style="width: 200px; height: 65px;" multiple></select></td>
								</tr>
								<tr>
									<td></td>
									<td>{cc_label_cco}</td>
								...
								<tr>
									...
									<td><select id="cc_email_win_cco" style="width: 200px; height: 65px;" multiple></select></td>
								</tr>								
							</table>
						</td>
					</tr>
...
<script type="text/javascript">
	...
	if (is_ie)
	{
		//document.body.onload = function(e) {setTimeout('emailWin_load_f()'); emailWin_load ? setTimeout('emailWin_load()', 10) : false;};
