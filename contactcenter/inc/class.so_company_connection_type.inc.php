<?php
  ...
  *  option) any later version.                                               *
  \***************************************************************************/
	...
	class so_company_connection_type extends so_type {

		function so_company_connection_type ( $id = false )
		{
			$this->init();
			...
			$this->main_fields = array(
				...
				'company_connection_type_name' => array(
					'name'  => 'company_connection_type_name',
					'type'  => false,
					'state' => 'empty',
					'value' => false
				)
			...
			$this->type_name = & $this->main_fields['company_connection_type_name'];

			$this->db_tables = array(
				'phpgw_cc_typeof_co_conns' => array(
					'type'   => 'main',
					'keys'   => array(
						'primary' => array(&$this->main_fields['id_typeof_company_connection']),
						'foreign' => false
					),
