<?php
  ...
  *  option) any later version.                                               *
  \***************************************************************************/
	...
	class so_contact_address_type extends so_type 
	{
	
		function so_contact_address_type ( $id = false )
		{
			$this->init();
			...
			$this->main_fields = array(
				...
				'contact_address_type_name' => array(
					'name'  => 'contact_address_type_name',
					'type'  => false,
					'state' => 'empty',
					'value' => false
				)
			...
			$this->type_name = & $this->main_fields['contact_address_type_name'];

			$this->db_tables = array(
				'phpgw_cc_typeof_ct_addrs' => array(
					'type'   => 'main',
					'keys'   => array(
						'primary' => array(&$this->main_fields['id_typeof_contact_address']),
						'foreign' => false
					),
