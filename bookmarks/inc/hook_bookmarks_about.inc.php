<?php
  ...
  function about_app()
  {
     global $phpgw, $phpgw_info, $HTTP_USER_AGENT;
     ...
     $tpl = new Template($phpgw->common->get_tpl_dir("bookmarks"));
     ...
     $tpl->set_var("create_url",$phpgw_info["server"]["webserver_url"] . "/login.php");
