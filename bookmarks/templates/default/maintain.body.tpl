...
<form method="post" action="{FORM_ACTION}">
 <table border=0 bgcolor="#EEEEEE" align="center">
  ...
  <tr>
   <td>
    <a href="{URL}">URL</a>&nbsp;
    <a href="{MAIL_THIS_LINK_URL}"><img align=top border=0 src="{IMAGE_URL_PREFIX}mail.gif"></a>
   </td>
  ...
  <tr>
   <td>Public<br></td>
   <td>
    <input type="checkbox" name="public" {PUBLIC_SELECTED}>
    <small>Check to allow others to see this bookmark</small>
   </td>
  </tr>
  ...
  <tr>
    ...
    <td>
     <strong>{ADDED}&nbsp;</strong>
     <input type="hidden" name="added" value="{ADDED_VALUE}">
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
     ...
     <input type="hidden" name="visted" value="{VISTED_VALUE}">
    </td>
  </tr>
