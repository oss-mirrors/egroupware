<?php
/**
 * eGroupWare - mail stationery
 *
 * @link http://www.egroupware.org
 * @package emailadmin
 * @author Christian Binder <christian@jaytraxx.de>
 * @copyright (c) 2009-2013 by christian@jaytraxx.de
 * @license http://opensource.org/licenses/gpl-license.php GPL - GNU General Public License
 * @version $Id$
 */

class emailadmin_bostationery
{
	/**
	 * application stationery is working for
	 *
	 */
	const _appname = 'emailadmin';
	
	/**
	 * prefix for the etemplate stationery templates
	 *
	 */
	const _stationery_prefix = 'emailadmin.stationery';
