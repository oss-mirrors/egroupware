...
{V_hidden_emails_list}
	<table style="width:100%">
		...
		{hideto_open}
			...
			<br>
			<p>
				<input type="button" name="tobutton" value="{to_button_value} :" onClick="
												javascript:
		...
		{hidecc_open}
			...
			<p>
				<input type="button"  name="ccbutton" value="{cc_button_value} :" onClick="javascript:mover.moveSelectedOptions('nameselect[]','ccselectbox[]');window.savedestboxes=1; ">
			</p>
			<br>
		{hidecc_close}
		{hidebcc_open}
			...
			<p>
				<input type="button" name="bccbutton"  value="{bcc_button_value}:" onClick="javascript:mover.moveSelectedOptions('nameselect[]','bccselectbox[]');window.savedestboxes=1;">
			</p>
			<br>
		{hidebcc_close}
			<br>
		...
		{hidecc_open}
		<p>             
			<select  name="ccselectbox[]" size="6" multiple="multiple" onChange="javascript:
											var selidx;
		...
		<p style="margin-bottom: 0cm;">             
			<select name="bccselectbox[]" size="6" multiple="multiple" onChange="javascript:
      									if(this.form.viewmore.checked)
      										{
											var selidx;
