  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
	...
	if ($d->total_records > $phpgw_info["user"]["preferences"]["common"]["maxmatchs"]) {
		...
		$lang_showing=lang("showing x",$d->total_records);
	}
	...
	$t->set_var('sort_etype',$phpgw->nextmatchs->show_sort_order($sort,'d_emailtype',$order,'/'.$phpgw_info['flags']['currentapp'].'/addressbook.php',lang('Email type')));
