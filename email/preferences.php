<?php
  ...
  *  option) any later version.                                              *
  \**************************************************************************/
	...
	if (isset($GLOBALS['phpgw']->msg->args['submit_prefs']))
	{
		...
		if ((isset($GLOBALS['phpgw']->msg->args['email_sig']))
		&& ($GLOBALS['phpgw']->msg->args['email_sig'] != ''))
		{
			// get rid of the escape \ that magic_quotes HTTP POST will add
 			// " becomes \" and  '  becomes  \'  and  \  becomes \\
			$email_sig_clean = $GLOBALS['phpgw']->msg->stripslashes_gpc($GLOBALS['phpgw']->msg->args['email_sig']);
		...
		else
		{
			...
			$GLOBALS['phpgw']->preferences->add('email','email_sig',$GLOBALS['phpgw']->msg->args['email_sig']);
		}

		$GLOBALS['phpgw']->preferences->delete('email','default_sorting');
		if ((isset($GLOBALS['phpgw']->msg->args['default_sorting']))
		&& ($GLOBALS['phpgw']->msg->args['default_sorting'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','default_sorting',$GLOBALS['phpgw']->msg->args['default_sorting']);
		}

		$GLOBALS['phpgw']->preferences->delete('email','layout');
		if ((isset($GLOBALS['phpgw']->msg->args['layout']))
		&& ($GLOBALS['phpgw']->msg->args['layout'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','layout',$GLOBALS['phpgw']->msg->args['layout']);
		}
		
		$GLOBALS['phpgw']->preferences->delete('email','show_addresses');
		if ((isset($GLOBALS['phpgw']->msg->args['show_addresses']))
		&& ($GLOBALS['phpgw']->msg->args['show_addresses'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','show_addresses',$GLOBALS['phpgw']->msg->args['show_addresses']);
		}
		
		$GLOBALS['phpgw']->preferences->delete('email','mainscreen_showmail');
		if ((isset($GLOBALS['phpgw']->msg->args['mainscreen_showmail']))
		&& ($GLOBALS['phpgw']->msg->args['mainscreen_showmail'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','mainscreen_showmail',$GLOBALS['phpgw']->msg->args['mainscreen_showmail']);
		}

		// save sent mail to the sent folder
		$GLOBALS['phpgw']->preferences->delete('email','use_sent_folder');
		if ((isset($GLOBALS['phpgw']->msg->args['use_sent_folder']))
		&& ($GLOBALS['phpgw']->msg->args['use_sent_folder'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','use_sent_folder',$GLOBALS['phpgw']->msg->args['use_sent_folder']);
		}

		// sent folder name to use
		$GLOBALS['phpgw']->preferences->delete('email','sent_folder_name');
		if ((isset($GLOBALS['phpgw']->msg->args['sent_folder_name']))
		&& ($GLOBALS['phpgw']->msg->args['sent_folder_name'] != ''))
		{
			// get rid of the escape \ that magic_quotes HTTP POST will add
 			// " becomes \" and  '  becomes  \'  and  \  becomes \\
			$sent_folder_name = trim($GLOBALS['phpgw']->msg->stripslashes_gpc($GLOBALS['phpgw']->msg->args['sent_folder_name']));
			if ($sent_folder_name == '')
			{
				// for some reason the user did not fill it in properly
				$sent_folder_name = $GLOBALS['phpgw']->msg->default_sent_folder;
			}
			$GLOBALS['phpgw']->preferences->add('email','sent_folder_name',$sent_folder_name);
		}

		// use trash folder
		$GLOBALS['phpgw']->preferences->delete('email','use_trash_folder');
		if ((isset($GLOBALS['phpgw']->msg->args['use_trash_folder']))
		&& ($GLOBALS['phpgw']->msg->args['use_trash_folder'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','use_trash_folder',$GLOBALS['phpgw']->msg->args['use_trash_folder']);
		}
		// trash folder name
		$GLOBALS['phpgw']->preferences->delete('email','trash_folder_name');
		if ((isset($GLOBALS['phpgw']->msg->args['trash_folder_name']))
		&& ($GLOBALS['phpgw']->msg->args['trash_folder_name'] != ''))
		{
			// get rid of the escape \ that magic_quotes HTTP POST will add
 			// " becomes \" and  '  becomes  \'  and  \  becomes \\
			$trash_folder_name = trim($GLOBALS['phpgw']->msg->stripslashes_gpc($GLOBALS['phpgw']->msg->args['trash_folder_name']));
			if ($trash_folder_name == '')
			{
				// for some reason the user did not fill it in properly
				$trash_folder_name = $GLOBALS['phpgw']->msg->default_trash_folder;
			}
			$GLOBALS['phpgw']->preferences->add('email','trash_folder_name',$trash_folder_name);
		}

		// use utf 7 internationalization encoding/decoding of folder names
		$GLOBALS['phpgw']->preferences->delete('email','enable_utf7');
		if ((isset($GLOBALS['phpgw']->msg->args['enable_utf7']))
		&& ($GLOBALS['phpgw']->msg->args['enable_utf7'] != ''))
		{
			$GLOBALS['phpgw']->preferences->add('email','enable_utf7',$GLOBALS['phpgw']->msg->args['enable_utf7']);
		}
		...
		if (!isset($GLOBALS['phpgw']->msg->args['use_custom_settings']))
		{
		...
		{
			$GLOBALS['phpgw']->preferences->add('email','use_custom_settings',$GLOBALS['phpgw']->msg->args['use_custom_settings']);
			...
			$c_check_array = count($check_array);
			for($i=0;$i<$c_check_array;$i++)
			{
				if ((isset($GLOBALS['phpgw']->msg->args[$check_array[$i]]))
				&& ($GLOBALS['phpgw']->msg->args[$check_array[$i]] != ''))
				{
					$GLOBALS['phpgw']->preferences->add('email',$check_array[$i],$GLOBALS['phpgw']->msg->args[$check_array[$i]]);
				}
				else
				{
					// so we'll use phpgwapi supplied value instead
					$GLOBALS['phpgw']->preferences->delete('email',$check_array[$i]);
				}
			}
			
			if ((isset($GLOBALS['phpgw']->msg->args['passwd']))
			&& ($GLOBALS['phpgw']->msg->args['passwd'] != ''))
			{
				...
				$encrypted_passwd = $GLOBALS['phpgw']->msg->stripslashes_gpc($GLOBALS['phpgw']->msg->args['passwd']);
				...
				//	.$GLOBALS['phpgw']->msg->decrypt_email_passwd($encrypted_passwd).'</pre>';
			}
			else
			{
...
// ----  Show The Preferences Page   -----
	...
	if ($GLOBALS['phpgw']->msg->args['totalerrors'])
	{
		//echo "<p><center>" . $GLOBALS['phpgw']->common->error_list($errors) . "</center>";
		$pref_errors = '<p><center>"' .$GLOBALS['phpgw']->common->error_list($GLOBALS['phpgw']->msg->args['errors']) .'"</center></p>';
	}
	else
	{
		$pref_errors = '';
	...
	// setup the form
	$t->set_var('form_action',$GLOBALS['phpgw']->link('/email/preferences.php'));
...
// ----  Typical (Non-Custom) Settings - Fill in HTML form -----
	...
	$layout_selected[1] = '';
	$layout_selected[2] = '';
	$layout_selected[$GLOBALS['phpgw_info']['user']['preferences']['email']['layout']] = ' selected';
	...
	$t->set_var('bg_row2A',$tr_color);
	$t->set_var('layout_blurb',lang('Message List Layout'));
	$t->set_var('layout_select_name','layout');
	$t->set_var('layout_select_options',$layout_select_options);
	...
	$tr_color = $GLOBALS['phpgw']->nextmatchs->alternate_row_color($tr_color);
	if (isset($GLOBALS['phpgw_info']['user']['preferences']['email']['mainscreen_showmail']))
	{
	...
	if (!isset($GLOBALS['phpgw_info']['user']['preferences']['email']['trash_folder_name']))
	{
		$t->set_var('trashname_text_value',$GLOBALS['phpgw']->msg->default_trash_folder);
	}
	else
	{
		$t->set_var('trashname_text_value',$GLOBALS['phpgw_info']['user']['preferences']['email']['trash_folder_name']);
	}

	// row5A = SENT folder options
	$tr_color = $GLOBALS['phpgw']->nextmatchs->alternate_row_color($tr_color);
	if (isset($GLOBALS['phpgw_info']['user']['preferences']['email']['use_sent_folder']))
	{
	...
	if (!isset($GLOBALS['phpgw_info']['user']['preferences']['email']['sent_folder_name']))
	{
		$t->set_var('sentname_text_value',$GLOBALS['phpgw']->msg->default_sent_folder);
	}
	else
	{
		$t->set_var('sentname_text_value',$GLOBALS['phpgw_info']['user']['preferences']['email']['sent_folder_name']);
	}
...
// ----  Custom Settings - Fill in HTML form -----
	...
	$tr_color = $GLOBALS['phpgw']->nextmatchs->alternate_row_color($tr_color);
	if (isset($GLOBALS['phpgw_info']['user']['preferences']['email']['use_custom_settings']))
	{
