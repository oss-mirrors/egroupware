      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
        <tr> 
            ...
            <table width=684 border=0 cellpadding=0 cellspacing=0>
              ...
              <tr> 
                ...
                <td width="430" height="20" background="templates/phpgroupware/images/current_release.gif"> 
        ...
        <tr> 
          <td bgcolor="#FFFFFF" height="5"> 
            <div align="center">
				<p>{site_footer}<a href="{?page_name=privacy}"><font color="537991" size="2"><font face="Verdana, Arial, Helvetica, sans-serif">privacy 
                policy</font></font></a> <font face="Verdana, Arial, Helvetica, sans-serif"><font size="2">&nbsp;&nbsp;&nbsp;<font color="537991">::</font> 
                &nbsp;&nbsp;&nbsp;<font color="537991">Copyright &copy; 2000 - 
                2002 phpGroupWare</font></font> <font size="2">&nbsp;&nbsp;&nbsp;<font color="537991">::</font> 
                &nbsp;&nbsp;&nbsp;<a href="http://www.ov-media.com/"><font color="537991">site design by ov media</font></a><br>
                <img src="templates/phpgroupware/images/spacer.gif" width="510" height="1"></font></font></p>
            </div>
          </td>
        </tr>
      </table>
