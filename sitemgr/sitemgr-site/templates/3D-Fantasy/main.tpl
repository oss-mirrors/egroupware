...
<table width="100%" border="0" align="center" bgcolor="#ffffff"><tr><td>
			<a href="index.php"><img src="themes/3D-Fantasy/images/logo.gif" border="0" alt="Welcome to {site_name}" align="left"></a>
			</td><td>
{site_header}
</td></tr></table>
</td>
...
{left_blocks}
</td><td valign="top"><img src="images/pix.gif" width="10" height="1" border="0" alt=""></td><td width="100%" valign="top">
<h1>{page_title}</h1>
<h3>{page_subtitle}</h3>
{page_content}
</td><td><img src="images/pix.gif" width="10" height="1" border="0" alt=""></td><td valign="top">
{right_blocks}
</td></tr></table>
<br>
<table border="0" cellspacing="0" cellpadding="0" width="100%"><tr>
...
<tr>
<td background="themes/3D-Fantasy/images/left2.gif" width="15">&nbsp;</td>
<td bgcolor="ffffff" width="100%" align="center"><font class="tiny">{site_footer}</font></td>
<td background="themes/3D-Fantasy/images/right2.gif">&nbsp;</td></tr>
<tr>
<td width="15" height="15"><img src="themes/3D-Fantasy/images/down-left2.gif" alt="" border="0"></td>
<td background="themes/3D-Fantasy/images/down2.gif" align="center" height="15">&nbsp;</td>
