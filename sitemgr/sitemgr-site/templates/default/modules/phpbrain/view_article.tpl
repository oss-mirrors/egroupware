...
<script type="text/javascript" src="/eg/phpgwapi/js/tabs/tabs.js"></script>
{message}
{link_main_view}
{search_tpl}
<div align="center">
	<script type="text/javascript">
		...
		<table  width="100%" border="0" cellspacing="0" cellpadding="3" style='border:1px solid black'>
			<tr class="th">
				<td colspan=3>
					<div class=divSideboxHeader style='font:bold 12px sans-serif;position: relative; text-align:left'>
		...
		<div id="tabcontent1" class="inactivetab">
			<table class="tabcontent" width="100%" border="0" cellspacing="1" cellpadding="3">
				...
				<tr class=divSideboxHeader style='text-align:left'>
				...
				<tr>
					<form method='POST' action="{form_article_action}">
						...
						<td style='padding-top:20px;padding-left:0px' width=1%>
								...
								<tr>
									<td>
										<table>
											...
											<tr>
												<td colspan=5>{lang_please_rate}:</td> 
											</tr>
											<tr>
											...
											<tr>
												<td colspan=2 style='text-align:left'>{lang_poor}</td>
												<td colspan=3 style='text-align:right'>{lang_excellent}</td>
											</tr>
