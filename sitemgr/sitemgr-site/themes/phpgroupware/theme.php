...
include("themes/phpgroupware/tables.php");
...
function themeheader() {
    $tmpl_file = "themes/phpgroupware/header.html";
...
function themefooter() {
    ...
    $tmpl_file = "themes/phpgroupware/center_bottom.html";
	$thefile = implode("", file($tmpl_file));
	$thefile = addslashes($thefile);
	$thefile = "\$r_file=\"".$thefile."\";";
	$thefile = parse_theme_vars($thefile);
    ...
    $tmpl_file = "themes/phpgroupware/footer.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
	$thefile = parse_theme_vars($thefile);
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
    ...
    $tmpl_file = "themes/phpgroupware/story_home.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
	$thefile = parse_theme_vars($thefile);
...
function themesidebox($title, $content) {
    $tmpl_file = "themes/phpgroupware/blocks.html";
    $thefile = implode("", file($tmpl_file));
    $thefile = addslashes($thefile);
    $thefile = "\$r_file=\"".$thefile."\";";
	$thefile = parse_theme_vars($thefile);
