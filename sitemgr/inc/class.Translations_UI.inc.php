...
//        'translation_manager' => lang('Translation Manager'),
				...
				'translate_site_content' => $GLOBALS['egw']->link('/index.php', $link_data),
				'lang_site_content' => lang('Translate site-wide content blocks'),
				'colspan' => (count($this->sitelanguages) + 2),
				'action_url' => $GLOBALS['egw']->link('/index.php',array('menuaction'=>'sitemgr.Translations_UI.manage')),
			));
			...
			if($cat_list)
			{
				...
				{     
					...
					$this->t->set_var('translatecat',
						'<form action="' . $GLOBALS['egw']->link('/index.php',$link_data) .
...
//          'translate' => lang('Translate Category'),
					...
					'action_url' => $GLOBALS['egw']->link('/index.php',array(
						'menuaction'=>'sitemgr.Translations_UI.translateCategory',
						'cat_id' => $cat_id,
					)),
				));
...
//          'pagename' => $page->name,
					...
					'lang_contentblocks' => lang('Content blocks for category'),
					'action_url' => $GLOBALS['egw']->link('/index.php',array(
						'menuaction'=>'sitemgr.Translations_UI.translatePage',
						'page_id' => $page_id,
					)),
				));
