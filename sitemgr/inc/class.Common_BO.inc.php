...
*/
        $file['Manage Notifications'] = $GLOBALS['phpgw']->link('/index.php', 'menuaction=sitemgr.Notifications_UI.list_all&site_id='.CURRENT_SITE_ID);
      }
//      $file['Manage Categories and pages'] = $GLOBALS['phpgw']->link('/index.php', 'menuaction=sitemgr.Outline_UI.manage');
      ...
      $file['Manage Notification Messages'] = $GLOBALS['phpgw']->link('/index.php', 'menuaction=sitemgr.NtfMessages_UI.list_all&site_id='.CURRENT_SITE_ID);
