	...
	class uimanagefields
	{
		...
		function admin ($message = NULL)
		{
			...
			$var = array (
				...
				'lang_text'  => lang ('Text'),
				'lang_type'  => lang ('Type'),
				'lang_values_and_shortdesc' => lang ('Values \'For Dropdown\': comma separated), For \'Dropdown From Table\': table,valuefield,displayfield'),
				...
				'lang_dropdownfromtable' => lang ('Dropdown From Table'),
			...
			while (list ($num, $field_info) = each ($fields))
			{
				...
				$var = array (
					...
					'field_type_selected_dropdownfromtable' => '',
