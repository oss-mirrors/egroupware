		...
		*/
		function vfs ()
		{
			...
			*/
			...
			$this->vfs_mimetypes =& CreateObject('filescenter.vfs_mimetypes',false);
			$this->vfs_mimetypes->set_vfs($this);

			$this->vfs_versionsystem =& CreateObject('filescenter.vfs_versionsystem',false);
			$this->vfs_versionsystem->set_vfs($this);

			$this->vfs_customfields =& CreateObject('filescenter.vfs_customfields');

			$this->vfs_sharing =& CreateObject('filescenter.vfs_sharing');
		}
...
/*			if ($id_type == "hex")
		...
		function import_vfs()
		{
			$filename = PHPGW_INCLUDE_ROOT.'filescenter/inc/class.vfs_sql.inc.php';
