...
<form method="POST" action="<?=$this->action?>">
   ...
   <div style="margin-top:5px;padding:2px;">
	...
	<li style="margin:2px;vertical-align:middle;padding:0px 2px 0px 7px;margin:0px;width:162px;overflow:hidden;white-space:nowrap;"><img src="<?=$GLOBALS[phpgw]->common->image('jinn','mini_navbar')?>" alt="" style="margin-right:2px;"><a style="color:white;" href="<?=$GLOBALS[egw]->link('/index.php','menuaction=jinn.uiuser.index&site_object_id='.$obj[value])?>"><?php echo $obj[name]?></a><?php //echo _debug_array($obj,false)?></li>	
	<?php endforeach?>
 </ul>
 <?php
	/*
