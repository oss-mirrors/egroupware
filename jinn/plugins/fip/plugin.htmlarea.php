 ...
 * version 2 of the License, or (at your option) any later version.        *
 \*************************************************************************/
	...
	* for which databasefieldtypes the plugin can be used for and more    *
	...
	$this->plugins['fip']['htmlarea']['name']		= 'htmlarea';
	$this->plugins['fip']['htmlarea']['title']		= 'HTMLarea plugin';
	$this->plugins['fip']['htmlarea']['version']		= '0.9';
	$this->plugins['fip']['htmlarea']['enable']		= 1;
	$this->plugins['fip']['htmlarea']['db_field_hooks']	= array
	(
		'text',
		'varchar',
		'blob'
	);
	$this->plugins['fip']['htmlarea']['config']		= array
	(
		'Enable_Tables'=>'False',
	...
	function plugin_htmlarea($field_name,$value)
	{
