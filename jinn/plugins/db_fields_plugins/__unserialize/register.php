...
/*
	...
	---------------------------------------------------------------------
*/
   $this->registry->plugins['unserialize']['name']				= 'unserialize';
   $this->registry->plugins['unserialize']['title']				= 'unserialize plugin';
   $this->registry->plugins['unserialize']['version']			= '0.1.2';
