...
/*
	...
	---------------------------------------------------------------------
*/
	$this->registry->plugins['default_date']['name'] 			= 'default_date';
	$this->registry->plugins['default_date']['title']			= 'default date';
	$this->registry->plugins['default_date']['version']			= '1.0';
