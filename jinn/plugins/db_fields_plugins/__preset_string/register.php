<?php
   ...
   */
   ...
   $this->registry->plugins['preset_string']['title']				= 'Preset Value';
   ...
   $this->registry->plugins['preset_string']['version']				= '0.2';
   ...
   */
   $this->registry->plugins['preset_string']['config2'] = array (
	  'Preset_Value' => array(
		 'name' => 'Preset_Value',
		 'label' => lang('Preset Value'),
		 'type' => 'area',
		 'size' => 100
	  )
   );
