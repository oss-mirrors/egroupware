...
//		$GLOBALS['egw_setup']->oProc->RenameColumn('egw_jinn_objects','disable_list_multi','disable_multi');
	...
	$test[] = '0.9.028';
	function jinn_upgrade0_9_028()
	{
//		$GLOBALS['egw_setup']->oProc->RenameColumn('egw_jinn_objects','disable_del','disable_multi');
/*		$GLOBALS['egw_setup']->oProc->AddColumn('egw_jinn_objects','disable_multi',array(
			'type' => 'bool',
			'nullable' => False,
			'default' => '0'
		 ));
...
*/
		return $GLOBALS['setup_info']['jinn']['currentver'] = '0.9.029';
	}

	$test[] = '0.9.029';
	function jinn_upgrade0_9_029()
	{
	   $GLOBALS['egw_setup']->oProc->AddColumn('egw_jinn_objects','disable_multi_rec',array(
		  'type' => 'bool',
		  'nullable' => False,
		  'default' => '0'
	   ));
	   $GLOBALS['egw_setup']->oProc->AddColumn('egw_jinn_objects','disable_del_rec',array(
		  'type' => 'bool',
		  'nullable' => False,
		  'default' => '0'
	   ));
	   ...
	   //$GLOBALS['egw_setup']->oProc->RenameColumn('egw_jinn_objects','disable_multi','disable_multi_rec');

	   return $GLOBALS['setup_info']['jinn']['currentver'] = '0.9.030';
	}
 

	$test[] = '0.9.030';
	function jinn_upgrade0_9_030()
	{
	   $GLOBALS['egw_setup']->oProc->AddColumn('egw_jinn_objects','disable_create_rec',array(
		  'type' => 'bool',
		  'nullable' => False,
		  'default' => '0'
	   ));
	   $GLOBALS['egw_setup']->oProc->RenameColumn('egw_jinn_objects','disable_multi_rec','disable_multi');
	...
	function jinn_upgrade0_9_151()
	{
		...
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','site_db_user',array(
			'type' => 'varchar',
			'precision' => '30'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','site_db_password',array(
			'type' => 'varchar',
			'precision' => '30'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','site_db_type',array(
			'type' => 'varchar',
			'precision' => '10'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','upload_path',array(
			'type' => 'varchar',
			'precision' => '250'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_site_db_name',array(
			'type' => 'varchar',
			'precision' => '100'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_site_db_host',array(
			'type' => 'varchar',
			'precision' => '50'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_site_db_user',array(
			'type' => 'varchar',
			'precision' => '30'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_site_db_password',array(
			'type' => 'varchar',
			'precision' => '30'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_site_db_type',array(
			'type' => 'varchar',
			'precision' => '10'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_upload_path',array(
			'type' => 'varchar',
			'precision' => '250'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','upload_url',array(
			'type' => 'varchar',
			'precision' => '250'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','dev_upload_url',array(
			'type' => 'varchar',
			'precision' => '250'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','object_scan_prefix',array(
			'type' => 'varchar',
			'precision' => '100'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','jinn_version',array(
		...
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','uniqid',array(
			'type' => 'varchar',
			'precision' => '30'
		));
		$GLOBALS['egw_setup']->oProc->AlterColumn('egw_jinn_sites','site_version',array(
		...
		return $GLOBALS['setup_info']['jinn']['currentver'] = '0.9.152';
	}
?>
