...
<hr align=left width=99% />-->
  ...
  <?php echo lang('Enter here the maximum number of entries to display in a documents history list'); ?>.
  <br /><br />
...
?>
  ...
  <?php echo lang('But display at least this many entries in RecentChanges and other subscription lists'); ?>:<br /><br />
  ...
  <?php echo lang('History display should show all changes made by the latest author.  Otherwise, show only the last change made'); ?>.<br />
