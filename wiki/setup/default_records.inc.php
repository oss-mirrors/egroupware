<?php
  ...
  *  option) any later version.                                              *
  ...
  /* $Id$ */
	...
	$oProc->query("INSERT INTO phpgw_wiki_pages (title,version,time,supercede,username,author,body,comment) VALUES ('PhpGroupWare',1,$time,$time,'setup','localhost','= PhpGroupWare =
