...
Private Sub IDTExtensibility2_OnConnection(ByVal Application As Object, _
    ...
    If oXL Is Nothing Then
        ConnectError "Error in OnConnection. Application = " & Application.Name & _
...
Private Sub IDTExtensibility2_OnStartupComplete(custom() As Variant)
    ...
    On Error Resume Next
    If oXL Is Nothing Then
        ConnectError "Application reference not received"
    End If
    ...
    End If
    If cbb Is Nothing Then
        ConnectError "Button could not be found or added"
    End If
...
Private Sub ConnectError(Description As String)
    On Error Resume Next
    Err.Clear
    Err.Raise vbObjectError + 614, "Connect", _
                                    Description
